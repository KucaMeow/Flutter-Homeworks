          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(
                  children: <Widget>[
                    const Text('Нравится: ', style: TextStyle(fontWeight: FontWeight.bold)),
                    Text(widget.post.likedBy.length.toString(), style: const TextStyle(fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
              Text(
